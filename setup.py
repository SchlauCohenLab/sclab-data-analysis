...
setup(
    name='sclab-data-analysis',  # Choose a custom name
    ...
    description='Library of useful analysis tools.',  # Meaningful short(!) description
    ...
    url='https://github.com/SchlauCohenLab/sclab-data-analysis',  # URL pointing to your project page
    keywords=['data analysis',             # Add tags here to be easier found by searches, e.g. on PyPI
